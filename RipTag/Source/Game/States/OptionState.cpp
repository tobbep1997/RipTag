...
void OptionState::_initButtons()
{
	...
	m_buttons.push_back(Quad::CreateButton(SWAP_RESOLUTION[m_resSelection], 0.5f, 0.40f, 0.70f, 0.17f));
	...
	m_buttons.push_back(Quad::CreateButton(SWAP_GRAPHICS[m_graphicsSelection], 0.5f, 0.31f, 0.70f, 0.17f));
	...
	m_buttons.push_back(Quad::CreateButton("Fullscreen: " + f, 0.5f, 0.22f, 0.70f, 0.17f));
	...
	m_buttons.push_back(Quad::CreateButton("Save and return", 0.5f, 0.13f, 0.70f, 0.17f));
	...
	//Background Window
	{
		...
		this->m_background->setUnpressedTexture("OPTIONSBG");
		this->m_background->setPressedTexture("OPTIONSBG");
		this->m_background->setHoverTexture("OPTIONSBG");
	}
}
...
void OptionState::Load()
{
	...
	Manager::g_textureManager.loadTextures("OPTIONSBG");
...
void OptionState::unLoad()
{
	...
	Manager::g_textureManager.UnloadTexture("OPTIONSBG");
