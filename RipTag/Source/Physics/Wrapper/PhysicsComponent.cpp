...
void PhysicsComponent::CreateShape(float x, float y, float z, float sizeX, float sizeY, float sizeZ, float friction, float density, std::string objectTag, bool isSensor)
{
